...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_bastion"></a> [bastion](#module\_bastion) | cloudposse/ec2-bastion-server/aws | 0.31.2 |
...
| <a name="input_bastion_instance_profile"></a> [bastion\_instance\_profile](#input\_bastion\_instance\_profile) | A pre-defined profile to attach to the instance | `string` | `""` | no |

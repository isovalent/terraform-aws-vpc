...
| <a name="input_bastion_subnet_ids"></a> [bastion\_subnet\_ids](#input\_bastion\_subnet\_ids) | The IDs of the subnets in which to place the bastion host. | `list(string)` | `[]` | no |
